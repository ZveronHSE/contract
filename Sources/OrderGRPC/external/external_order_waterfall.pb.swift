...
public struct WaterfallOrder {
  ...
  public var serviceDatetime: String = String()
...
extension WaterfallOrder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .standard(proto: "service_datetime"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularStringField(value: &self.serviceDatetime) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.serviceDatetime.isEmpty {
      try visitor.visitSingularStringField(value: self.serviceDatetime, fieldNumber: 6)
    }
  ...
  public static func ==(lhs: WaterfallOrder, rhs: WaterfallOrder) -> Bool {
    ...
    if lhs.serviceDatetime != rhs.serviceDatetime {return false}
