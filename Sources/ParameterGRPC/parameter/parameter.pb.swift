...
public struct ParameterValueRequest {
  ...
  public var parameterValues: Dictionary<Int32,String> = [:]
...
extension ParameterValueRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.categoryID) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.lotFormID) }()
      case 3: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufInt32,SwiftProtobuf.ProtobufString>.self, value: &self.parameterValues) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.parameterValues.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufInt32,SwiftProtobuf.ProtobufString>.self, value: self.parameterValues, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
