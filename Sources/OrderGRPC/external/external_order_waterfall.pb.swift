...
public struct GetFilteredCountRequest {
...
public struct GetFilteredCountResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension GetFilteredCountRequest: @unchecked Sendable {}
extension GetFilteredCountResponse: @unchecked Sendable {}
...
extension GetFilteredCountRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetFilteredCountRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: GetFilteredCountRequest, rhs: GetFilteredCountRequest) -> Bool {
...
extension GetFilteredCountResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetFilteredCountResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "count"),
  ]
  ...
  public static func ==(lhs: GetFilteredCountResponse, rhs: GetFilteredCountResponse) -> Bool {
